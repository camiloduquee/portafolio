  ...
  return (
    ...
    >
      <Link href={props.url} target="_blank" rel="noopener noreferrer">
        <section className=" bg-gray-100 max-w-[52rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[24rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
          <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
            <h3 className="text-2xl font-semibold">{props.title}</h3>
            <p className=" text-xs mt-2 leading-relaxed text-gray-700 dark:text-white/70">
              {props.description}
            </p>
            <ul className="flex flex-wrap mt-2 gap-2 sm:mt-auto max-sm:pt-5">
